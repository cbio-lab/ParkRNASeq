...
This repository contains datasets, analysis pipelines, and results from an RNA-sequencing study comparing transcriptomic profiles of induced pluripotent stem cell (iPSC)-derived dopaminergic neurons from:
    ...
    1) Healthy control donors (n=16)

    2) Parkinson's disease patients with pathogenic LRRK2 G2019S mutations (n=7)

    3) Parkinson's disease patients with biallelic PARKIN mutations (n=16)

**DATA**: `/data18/bio/DATA/PARK_RNASeq_2023/reads/raw`

**scripts**: `/data18/bio/DATA/PARK_RNASeq_2023/src`
